                  ...
                  >
                    ...
                    {theme === 'dark' ? (
                      <svg
                        ...
                        className="h-5 w-5 fill-slate-700 dark:fill-slate-500 hover:fill-primary dark:hover:fill-sky-400"
                        viewBox="0 0 20 20"
                        fill="currentColor"
                      >
                      ...
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-5 w-5 fill-slate-400 dark:fill-slate-100 hover:fill-primary dark:hover:fill-sky-400"
                        viewBox="0 0 20 20"
                        fill="currentColor"
                      >
                        <path
                ...
                <li className="px-3 flex-row items-center">
                  <Link href="/languages/language-selection">
                    <a>
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className="h-5 w-5 fill-slate-400 dark:fill-slate-500 hover:fill-primary dark:hover:fill-sky-400"
                        viewBox="0 0 20 20"
                        fill="currentColor"
                      >
                        <path
