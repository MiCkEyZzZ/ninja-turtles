  ...
  return (
    <div className="text-right">
      <Menu as="div" className="relative inline-block text-left">
        <div>
          <Menu.Button className="inline-flex w-full justify-center rounded-md bg-black bg-opacity-0 px-4 py-2 text-sm font-medium text-white hover:text-primary focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75">
            Ещё
        ...
        >
          <Menu.Items className="absolute right-0 z-10 mt-7 w-56 origin-top-right divide-y divide-gray-100 rounded-md bg-white dark:bg-gray-750 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
            <div className="px-1 py-1 ">
              <Menu.Item>
                {({ active }) => (
                  <button
                    className={`${
                      active ? 'bg-primary dark:bg-sky-400 text-white' : 'text-gray-900'
