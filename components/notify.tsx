            ...
            <div className='flex flex-col md:flex-row justify-between w-full max-w-screen-2xl items-center px-3 py-8 md:px-0 md:py-0 md:px-6 lg:px-8'>
                <div className='flex flex-row items-center'>
                    ...
                    <div className='dark:text-gray-0'>
                        ...
                        <p className="mt-1 opacity-70">Не стесняйтесь задавать вопросы, сообщать
                            о проблемах и знакомится с новыми людьми.</p>
                    </div>
                </div>
                <Link href='https://t.me/the_ninja_turtles_api'>
                    <a target='_blank' className='bg-primary transition duration-300 ease-in-out hover:bg-green-100 focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-offset-2 focus:ring-offset-slate-50 text-white-900 font-semibold h-12 mt-6 md:mt-0 px-6 rounded-lg w-full flex items-center justify-center sm:w-auto dark:bg-sky-500 dark:highlight-white/20 dark:hover:bg-sky-400'
                    >@TNTAPI Telegram</a>
                </Link>
            </div>
        </section>
